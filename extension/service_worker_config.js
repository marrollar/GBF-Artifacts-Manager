...
const urlFilter = {
    ...
    // soloRewardUrlRegex: maybe(),
    // raidRewardUrl: "resultmulti\/content\/index\/\\d{11}",
    // raidRewardUrlRegex: maybe(),
    // soloOrRaidRewardUrl: maybe(),
    // rewardUrlRegex: maybe(),
