...
export const SK2_NAMES: FilterButtonData[] = [
    ...
    { name: "Boost triple attack rate when at or above 50% HP by", aliases: ["Boost T.A. rate when at or above 50% HP by", "Boost TA rate when at or above 50% HP by"] },
...
export const SK3_NAMES: FilterButtonData[] = [
    ...
    { name: "Upon using a healing skill: Ally in the next position gains a 1-time Bonus Elemental DMG effect of", aliases: ["Upon using a healing skill: Ally in the next position gains a 1 time echo of"] },
    ...
    { name: "Gain a Bonus Elemental DMG effect (1 time) after being targeted by foes' attacks", aliases: ["Gain a 1 time echo after being targeted by foes' attacks"] },
    { name: "At end of turn if equipper didn't attack: Gain" },
    { name: "Upon using a green or blue potion (Max 1 of this skill per party): Boost Fated Chain bar by", aliases: ["Upon using a green or blue potion (Max 1 of this skill per party): Boost FC bar by "] },
    { name: "Gain a 3-hit Flurry effect (1 time) after hitting a foe" },
    { name: "When knocked out (1 time): All allies gain" },
    { name: "When switching to a main ally (1 time): Amplify DMG by", aliases: ["When switching to a main ally (1 time): Amp DMG by"] },
    ...
    { name: "Start battle with 20% of HP consumed / After 3 turns: DMG cap is boosted by", aliases: ["Start battle with 20% HP cut / After 3 turns: DMG cap is boosted by"] },
    { name: "Upon casting first-slot skill: Cut first-slot skill's cooldown by 1 turn and consume this percentage of current HP (HP consumption lowers with higher lvls of this artifact skill):", aliases: ["Upon casting first slot skill: Cut first slot skill's cooldown by 1 turn and consume this percentage of current HP (HP consumption lowers with higher lvls of this artifact skill):"] },
    { name: "Chance to gain a 6-hit Flurry effect (1 time) before attacking:" },
    { name: "Chance of battle turn progressing by 5 at end of turn (Max 1 of this skill per party):", aliases: ["Akasha"] },
    { name: "Chance to remove all buffs from a foe at end of turn:", aliases: ["Chance to dispel all buffs from a foe at end of turn:"] },
